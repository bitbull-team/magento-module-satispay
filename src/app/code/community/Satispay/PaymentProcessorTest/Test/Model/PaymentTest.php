...
class Satispay_PaymentProcessorTest_Test_Model_PaymentTest
    extends EcomDev_PHPUnit_Test_Case
{
     ...
     * Payment instance
     *
     * @var Satispay_PaymentProcessor_Model_Payment
     */
    private $payment;
     ...
     * Session instance
     *
     * @var Satispay_PaymentProcessor_Model_Session
     */
    private $session;
    ...
    protected function setUp()
    {
        ...
        $this->payment = new Satispay_PaymentProcessor_Model_Payment();
    ...
    {
        $this->assertTrue($this->session instanceof Satispay_PaymentProcessor_Model_Session);
    }
